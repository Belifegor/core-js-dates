...
function getNextFriday(date) {
  ...
  dateObj.setDate(dateObj.getDate() + (diff >= 0 ? diff : 7 + diff));
  return dateObj;
}
...
function formatDate(date) {
  ...
  return `${month}/${day}/${year}, ${hours}:${padMin}:${padSec} ${AM_PM}`;
}
